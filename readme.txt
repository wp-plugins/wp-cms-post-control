=== WP-CMS Post Control ===Contributors: Jonnya, Brady J. Frey, Owen Winker, Mark Jaquith, Achim Staebler
...
Tags: post, page, postsRequires at least: 2.5Tested up to: 2.6Stable tag: 0.2BETA TESTING VERSION!! Post Control hides unwanted items on the write page and write post pages within WordPress, eg custom fields, trackbacks etc.
...
* Introduce simple role management so 'admin' gets all options
* 'Insert notes' option
...
Coming very soon - certainly with next version!
