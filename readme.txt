...
v0.3 introduces a new control that allows admin level users to either see all the default options, or have the options applied as per the plugin settings. Previously, the options selected where global, effecting all users including admins.== Installation ==1. Upload `wp-cms-post-control.php` to the `/wp-content/plugins/` directory2. Activate the plugin through the 'Plugins' menu in WordPress3. Configure options through `Settings > Post Control`

= Update =

1. Deactivate the plugin on plugins page (clears preferences from database on de-activation)
2. Replace old version of `wp-cms-post-control.php` on server with new version
3. Re-activate it on your plugins page
...
1. Here is the administration panel with all the options shown and new admin user control menu introduced in v0.3

2. Here is an example of a simplified write post page - nice and simple for users

== Development Notes ==

*v0.2*

* First public release (25th July 2008)

*v0.3*

* Second public release (27th July 2008)
* Implemented admin control for write panel