...
function wpcms_post_control_options() {
	...
	if (isset($_POST['wpcms_post_control_options_update'] ) ) {
		...
		$options = get_option('wpcms_post_control_options');
		echo '<div class="updated">' . __('Post Control options updated.','wpcms_post_control') . '</div>';
	}
	?>
	...
	<p class="submit"><input type="submit" name="Submit" value="<?php _e('Save options','wpcms_post_control'); ?>" /></p>
	</form>
	</div>
	<?php
}
